...
EQL supports the concept of recursive queries. For example, imagine the scenario of trying to load a structure
like a file system, where folders recursively contain folders.
